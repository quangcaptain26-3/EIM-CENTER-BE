...
('00000000-0000-0000-0000-000000000003', 'ACCOUNTANT', 'Nhân viên Kế toán',
 '["receipt:create","refund:approve","receipt:void","payroll:finalize","payroll:read","finance:dashboard","debt:read","enrollment:read","enrollment:transfer_tuition","student:read"]'),
