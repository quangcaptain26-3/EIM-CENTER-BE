...
INSERT INTO curriculum_programs (id, code, name, level, total_units, lessons_per_unit, sessions_per_week) VALUES
  ('6202f645-b04c-476f-a997-627de8f2b5ae', 'KINDY',    'Kindy English',       'KINDY',    10, 7, 2),
  ('d0af2da6-2e86-41e4-9400-34160e9ac6ae', 'STARTERS', 'Cambridge Starters',  'STARTERS', 12, 7, 2),
  ('53b4eb2f-61b7-45c1-90b1-1a94fcfd5fe9', 'MOVERS',   'Cambridge Movers',    'MOVERS',   12, 7, 2),
  ('f5591e8f-185b-4a73-8e15-4a27c678ff16', 'FLYERS',   'Cambridge Flyers',    'FLYERS',   12, 7, 2)
...
-- Seed thêm các chương trình khác (rút gọn)
